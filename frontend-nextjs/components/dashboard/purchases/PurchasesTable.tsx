        ...
        {purchases?.map((purchase) => (
            ...
            >
              ...
              <td className="p-3 text-right tabular-nums font-medium">
                {Number(purchase.details.total_amount).toLocaleString()}
              </td>

              <td className="p-3 text-right tabular-nums">
                {Number(purchase.details.total_quantity).toLocaleString()}
              </td>

              <td className="p-3 text-right tabular-nums">
                {Number(purchase.details.amount_due) > 0
                  ? Number(purchase.details.amount_due).toLocaleString()
                  : "—"}
              </td>
