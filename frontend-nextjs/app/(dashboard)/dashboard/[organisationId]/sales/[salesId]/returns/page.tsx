...
export default async function ReturnsPage({
  ...
  const response = await getSalesPurchaseReturns(organisationId, salesId, 'sales', {
    page,
  });
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-4 px-4">
      {/* FILTERS */}
      <BillInvoicePaymentsHeader title={response.title} downloadType={`sales/${salesId}/returns`} page={page} />
