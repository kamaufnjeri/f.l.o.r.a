...
const SalesReturnModal = ({ openModal, setOpenModal, title, sales, onSalesReturn }) => {
    ...
    useEffect(() => {
        if (openModal) {
            const newStocks = sales.sales_entries.map(
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await postRequest(formData, `${orgId}/sales_returns`);
        ...
        if (response.success) {
            ...
            onSalesReturn();
            toast.success('Recorded: Sales return recorded successfully');
