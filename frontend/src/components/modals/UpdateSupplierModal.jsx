...
const UpdateSupplierModal = ({ setSupplierData, supplierData, setOpenModal, openModal }) => {
    ...
    return (
        <>
          ...
          <Modal
            title={`Update supplier ${supplierData.name}`}
            open={openModal}
          ...
          >
            <Formik
              ...
              onSubmit={async (values, { resetForm }) => {
                const response = await patchRequest(values, `${orgId}/suppliers/${supplierData.id}`);
                if (response.success) {
                  toast.success('Recorded: Supplier updated successfully');
