...
const BillInvoiceAccountsFields = ({ header, values, setFieldValue, accounts, type }) => {
    return (
        <div className='flex flex-col gap-2 w-full pl-2'>
            ...
            <Row className='flex flex-row w-full gap-5'>
                        ...
                        <Col className='w-[30%]'><span>Account</span></Col>

                        <Col className='w-[30%]'><span>Amount</span></Col>
                        <Col className='w-[10%]'>Remove</Col>

            </Row>
            {values.journal_entries.map((entry, index) => (
                <Row key={index} className='flex flex-row w-full gap-5'>
                    ...
                    <Col className='w-[30%]'>
                        ...
                        </Col>{values.journal_entries.length > 1 && (<Col className='w-[10%]'>
                                <Button
                                    type="danger"
                                    onClick={() => {
...
export default BillInvoiceAccountsFields
