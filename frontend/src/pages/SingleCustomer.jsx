           ...
           border-2 border-gray-300 shadow-sm flex flex-col items-start font-normal ${isVisible ? 'show-header-dropdown' : 'hide-header-dropdown'}`}>
            ...
            <div className='overflow-auto custom-scrollbar flex flex-col flex-1 max-h-[75%] w-full m-2'>
                ...
                <div className='w-full flex flex-row text-xl font-bold border-y-2 border-gray-800 border-l-2'>
                    <span className='w-[10%] border-gray-800 border-r-2 p-1'>Invoic #</span>
                ...
                {customerData?.customer_data && customerData.customer_data.invoices.map((invoice, index) => (
                    <div className={`w-full flex flex-row font-bold border-b-2 border-gray-800 border-l-2 hover:bg-gray-300 hover:cursor-pointer`} key={index}>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1'>{ invoice.invoice_no}</span>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1 '>{invoice.date}</span>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1 '>{invoice.due_date}</span>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1 '>{invoice.invoice_type}</span>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1 '>{invoice.status}</span>
                        <span className='w-[10%] border-gray-800 border-r-2 p-1 '>{invoice.due_days}</span>
                        <span className='w-[20%] border-gray-800 border-r-2 p-1'>{invoice.description}</span>
