...
AUTH_USER_MODEL = 'journals.FloraUser'  # Adjust the app name as necessary
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=1),  # Set access token lifetime
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),  # Set the authentication header type
