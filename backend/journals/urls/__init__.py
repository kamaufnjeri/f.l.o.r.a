...
urlpatterns = [
    ...
    path('<organisation_id>/purchases/returns/', include(purchase_return_urls)),
    path('<organisation_id>/purchases/', include(purchase_urls)),
    path('<organisation_id>/sales/returns/', include(sales_return_urls)),
    ...
    path('<organisation_id>/select-options/', include(select_options_urls)),
    path('<organisation_id>/reports/', include(reports_urls)),
